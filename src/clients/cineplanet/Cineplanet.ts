...
export class Cineplanet {
    ...
    static async getMovies(cookie:string, url:string, subKey:string): Promise<CineplanetBillboard>{
    ...
    static async getShowings(cookie: string, url: string, subKey: string): Promise<CineplanetSessions>{
